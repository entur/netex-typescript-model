...
- `scripts/lib/to-xml-shape.ts` — static generator for stem→XML projection functions and inline code blocks. Exports: `makeInlinedToXmlShape`, `makeInlineCodeBlock`
